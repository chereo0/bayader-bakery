            ...
            <form onSubmit={onSubmit} aria-label="Sign up form">
              ...
              <div className="mt-6">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="bg-[#6b3f2f] hover:bg-[#5a3426] text-white px-6 py-2 rounded-md shadow-md transform transition-transform hover:scale-105 w-full md:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
                >
